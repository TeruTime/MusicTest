...
public class MainActivity extends ActionBarActivity implements MusicListFragment.OnFragmentInteractionListener, PlayListFragment.OnPlayListInteractionListener, MusicPlayerService.Callbacks, MusicPlayerFragment.OnMusicPlayerListener{
    ...
    {
        //Create new fragment to display the music infor and album etc...
        //However I would assume that the musicplayer itself would be run on either the main activity
        //of as a seperate thread from the UI as we want the ability to start and stop the music player
