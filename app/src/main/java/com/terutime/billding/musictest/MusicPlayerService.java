...
public class MusicPlayerService extends Service
{
	...
	public int onStartCommand(Intent intent, int flags, int startId)
	{
		...
		if(intent != null)
		{
			...
			//This listener waits for the asynchronous prepare to finish
			...
			//Listener activates when the media player finishes playback
			...
			//ready the media player with the given song and prepare the player
			setMpDataSource();
	...
	//TODO: add function in which we can start a preset playlist
	 ...
	 */
	//Call this function when we want to prepare the music player at with a specific song on the playlist
	public void setMpDataSource(int position)
	{
		//load the new music file
		try
		{
			mediaPlayer.setDataSource(getApplicationContext(), playList.get(position));
		}
		catch (IOException e)
		{
			e.printStackTrace();
	...
	//Release the memory held by the media player on the destruction of this service
	@Override
	...
	//bind callbacks with an activity
